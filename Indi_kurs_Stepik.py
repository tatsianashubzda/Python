...
# Программа получает на вход две строки S1 и S2. Если строка S1 является анаграммой строки S2 нужно вывести YES, в противном 
...
st1, st2 = input(), input()
print('YES') if dict_str(st1) == dict_str(st2) else print('NO')
